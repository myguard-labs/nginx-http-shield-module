...
30 categories (656 signatures), all matched case-insensitively after
percent-decoding:
...
| `webshell` | `c99.php`, `r57.php`, `wso.php`, `weevely`, `behinder`, `shell.php?cmd=`, `spinstall0.aspx` (SharePoint ToolShell persistence) |
